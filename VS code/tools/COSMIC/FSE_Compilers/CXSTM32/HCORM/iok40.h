/*	IO DEFINITIONS FOR KINETIS K40
...
struct __nv__ {
	...
	__REGB__ FPROT3;                 /* Non-volatile P-Flash Prot 1 Low */
	__REGB__ FPROT2;                 /* Non-volatile P-Flash Prot 1 High */
	__REGB__ FPROT1;                 /* Non-volatile P-Flash Prot 0 Low */
	__REGB__ FPROT0;                 /* Non-volatile P-Flash Prot 0 High */
	__REGB__ FSEC;                   /* Non-volatile Flash Security */
	__REGB__ FOPT;                   /* Non-volatile Flash Option */
	__REGB__ FEPROT;                 /* Non-volatile EERAM Protection */
	__REGB__ FDPROT;                 /* Non-volatile D-Flash Protection */
	};
 ...
 */
struct __lcd__ {
	__REGW__ GCR;                   /* LCD general control register */
	__REGW__ AR;                    /* LCD auxiliary register */
	__REGW__ FDCR;                  /* LCD fault detect control register */
	__REGW__ FDSR;                  /* LCD fault detect status register */
	__REGW__ PEN[2];                /* LCD pin enable register */
	__REGW__ BPEN[2];               /* LCD backplane enable register */
	union {
		__REGW__ WF[16];        /* LCD waveform register */
		__REGB__ WF8B[64];      /* LCD Waveform Registers */
		};
	};

struct __lcd__ LCD	@0x400BE000;
