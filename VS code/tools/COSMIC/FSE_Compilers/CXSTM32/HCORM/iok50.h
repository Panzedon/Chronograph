/*	IO DEFINITIONS FOR KINETIS K50
...
struct __opamp__ {
	...
	__REGB__ C1;                    /* Control Register 0 */
	__REGB__ C2;                    /* Control Register 0 */
	};

struct __opamp__ OPAMP0	@0x400f5000;
struct __opamp__ OPAMP1	@0x400f5800;
...
struct __triamp__ TRIAMP0	@0x400f8000;
struct __triamp__ TRIAMP1	@0x400f8800;
