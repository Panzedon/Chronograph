...
struct __aes__ {
	...
	__REGW__ DINR;                  /* data input register */      
	__REGW__ DOUTR;                 /* data output register */
	__REGW__ KEYR0;                 /* key register 0 */
	__REGW__ KEYR1;                 /* key register 1 */
	__REGW__ KEYR2;                 /* key register 2 */
	__REGW__ KEYR3;                 /* key register 3 */
	__REGW__ IVR0;                  /* initialization vector register 0 */
	__REGW__ IVR1;                  /* initialization vector register 1 */
	__REGW__ IVR2;                  /* initialization vector register 2 */
	__REGW__ IVR3;                  /* initialization vector register 3 */
	__REGW__ KEYR4;                 /* key register 4 */
	__REGW__ KEYR5;                 /* key register 5 */
	__REGW__ KEYR6;                 /* key register 6 */
	__REGW__ KEYR7;                 /* key register 7 */
	__REGW__ SUSP0R;                /* suspend register 0 */
	__REGW__ SUSP1R;                /* suspend register 1 */
	__REGW__ SUSP2R;                /* suspend register 2 */
	__REGW__ SUSP3R;                /* suspend register 3 */
	__REGW__ SUSP4R;                /* suspend register 4 */
	__REGW__ SUSP5R;                /* suspend register 5 */
	__REGW__ SUSP6R;                /* suspend register 6 */
	__REGW__ SUSP7R;                /* suspend register 7 */
	};

struct __aes__ AES	@0x40026000;
 ...
 */
struct __comp__ {
	__REGW__ CSR1;                  /* control and status register 1 */
	__REGW__ CSR2;                  /* control and status register 2 */
	__REGW__ CSR3;                  /* control and status register 3 */
	};

struct __comp__ COMP	@0x40010200;
...
struct __crs__ CRS	@0x40006C00;

/*	DAC section
 */
struct __dac__ {
	__REGW__ CR;                    /* control register */
	__REGW__ SWTRGR;                /* software trigger register */
	...
	__REGW__ DHR12RD;               /* dual 12-bit right align data reg */
	__REGW__ DHR12LD;               /* dual 12-bit left align data reg */
	__REGW__ DHR8RD;                /* dual 8-bit right align data reg */
	__REGW__ DOR1;                  /* chan 1 data output register */
	__REGW__ DOR2;                  /* chan 2 data output register */
	__REGW__ SR;                    /* status register */
	__REGW__ CCR;                   /* calibration control register */
	__REGW__ MCR;                   /* mode control register */
	__REGW__ SHSR1;                 /* chan 1 sample and hold sample time register */
	__REGW__ SHSR2;                 /* chan 2 sample and hold sample time register */
	__REGW__ SHHR;                  /* sample and hold time register */
	__REGW__ SHRR;                  /* sample and hold refresh time register */
	};
...
struct __exti__ {
	...
	__REGW__ RTSR2;                 /* rising trigger selection register 2 */
	__REGW__ FTSR2;                 /* falling trigger selection register 2 */
	__REGW__ SWIER2;                /* Software interrupt event register 2 */
	__REGW__ RPR2;                  /* rising edge pending register 2 */
	__REGW__ FPR2;                  /* falling edge pending register 2 */
	__REGW__ reserved_1[9];
	...
	__REGW__ IMR2;                  /* interrupt mask register 2 */
	__REGW__ EMR2;                  /* event mask register 2 */
	};
 ...
 */
struct __fdcan__ {
	__REGW__ CREL;                  /* core release register */
	__REGW__ ENDN;                  /* endian register */
	__REGW__ reserved_0;
	__REGW__ DBTP;                  /* data bit timing and prescaler register */
	__REGW__ TEST;                  /* test register */
	__REGW__ RWD;                   /* ram watchdog register */
	__REGW__ CCCR;                  /* cc control register */
	__REGW__ NBTP;                  /* nominal bit timing and prescaler register */
	__REGW__ TSCC;                  /* timestamp counter configuration register */
	__REGW__ TSCV;                  /* timestamp counter value register */
	__REGW__ TOCC;                  /* timeout counter configuration register */
	__REGW__ TOCV;                  /* timeout counter value register */
	__REGW__ reserved_1[4];
	__REGW__ ECR;                   /* error counter register */
	__REGW__ PSR;                   /* protocol status register */
	__REGW__ TDCR;                  /* transmitter delay compensation register */
	__REGW__ reserved_2;
	__REGW__ IR;                    /* interrupt register */
	__REGW__ IE;                    /* interrupt enable register */
	__REGW__ ILS;                   /* interrupt line select register */
	__REGW__ ILE;                   /* interrupt line enable register */
	__REGW__ reserved_3[8];
	__REGW__ RXGFC;                 /* global filter configuration register */
	__REGW__ XIDAM;                 /* extended ID and mask register */
	__REGW__ HPMS;                  /* high priority message status register */
	__REGW__ RXF0S;                 /* rx fifo 0 status register */
	__REGW__ RXF0A;                 /* rx fifo 0 acknowledge register */
	__REGW__ RXF1S;                 /* rx fifo 1 status register */
	__REGW__ RXF1A;                 /* rx fifo 1 acknowledge register */
	__REGW__ reserved_4[8];
	__REGW__ TXBC;                  /* tx buffer configuration register */
	__REGW__ TXFQS;                 /* tx fifo queue status register */
	__REGW__ TXBRP;                 /* tx buffer request pending register */
	__REGW__ TXBAR;                 /* tx buffer and address register */
	__REGW__ TXBCR;                 /* tx buffer cancellation request register */
	__REGW__ TXBPO;                 /* tx buffer transmission occured register */
	__REGW__ TXBCF;                 /* tx buffer cancellation finished register */
	__REGW__ TXBTIE;                /* tx buffer transmission interrupt enable register */
	__REGW__ TXBCIE;                /* tx buffer cancellation finished interrupt enable register */
	__REGW__ TXEFS;                 /* tx event fifo status register */
	__REGW__ TXEFA;                 /* tx event fifo acknowledge register */
	__REGW__ reserved_5[20];
	__REGW__ CKDIV;                 /* clock divider register */
	};

struct __fdcan__ FDCAN1	@0x40006400;
struct __fdcan__ FDCAN2	@0x40006800;
...
struct __flash__ {
	...
	__REGW__ PCROP1ASR;             /* pcrop1 area a start address register */
	__REGW__ PCROP1AER;             /* pcrop1 area a end address register */
	__REGW__ WRP1AR;                /* wrp1 area a address register */
	__REGW__ WRP1BR;                /* wrp1 area b address register */
	__REGW__ PCROP1BSR;             /* pcrop1 area b start address register */
	__REGW__ PCROP1BER;             /* pcrop1 area b end address register */
	__REGW__ reserved_1[3];
	__REGW__ PCROP2ASR;             /* pcrop2 area a start address register */
	__REGW__ PCROP2AER;             /* pcrop2 area a end address register */
	__REGW__ WRP2AR;                /* wrp2 area a address register */
	__REGW__ WRP2BR;                /* wrp2 area b address register */
	__REGW__ PCROP2BSR;             /* pcrop2 area b start address register */
	__REGW__ PCROP2BER;             /* pcrop2 area b end address register */
...
struct __lptim__ {
	...
	__REGW__ CFGR;                  /* configuration register */
	__REGW__ CR;                    /* control register */
	__REGW__ CMP;                   /* compare register */
	__REGW__ ARR;                   /* autoreload register */
	__REGW__ CNT;                   /* counter register */
	__REGW__ reserved_0;
	__REGW__ CFGR2;                 /* configuration register 2 */
	};

struct __lptim__ LPTIM1	@0x40007C00;
struct __lptim__ LPTIM2	@0x40009400;
...
struct __lpuart__ {
	...
	__REGW__ BRR;                   /* Baud rate register */
	__REGW__ reserved_0[2];
...
struct __lpuart__ LPUART1	@0x40008000;
struct __lpuart__ LPUART2	@0x40008400;
...
struct __rcc__ {
	...
	__REGW__ reserved_0;            
	__REGW__ CRRCR;                 /* clock recovery rc register */
...
struct __ucpd__ {
	...
	__REGW__ CFG3;                  /* configuration register 3 */
	__REGW__ CR;                    /* control register */
	__REGW__ IMR;                   /* interrupt mask register */
	__REGW__ SR;                    /* status register */
	__REGW__ ICR;                   /* interrupt clear register */
	__REGW__ TXORDSET;              /* tx ordered set register */
	__REGW__ TXPAYSZ;               /* tx payload size register */
	__REGW__ TXDR;                  /* tx data register */
	__REGW__ RXORDSET;              /* rx ordered set register */
	__REGW__ RXPAYSZ;               /* rx payload size register */
	__REGW__ RXDR;                  /* rx data register */
	__REGW__ RXORDEXT1;             /* rx ordered set extension register 2 */
	__REGW__ RXORDEXT2;             /* rx ordered set extension register 2 */
	};

struct __ucpd__ UCPD1	@0x4000A000;
struct __ucpd__ UCPD2	@0x4000A400;
...
struct __vrefbuf__ VREFBUF @0x40002c00;
